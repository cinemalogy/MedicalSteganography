...
Public Class OutPatientList
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim adp As New SqlDataAdapter("Select opCode,opName,PhoneNo,ProfessionName From OutPatientTab  order by opcode", Conn)
        adp.Fill(DS1)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        YPos += 100
        XPos = 10
        e.Graphics.DrawString("Out Patient List Report", MyFont, Brushes.Black, XPos, YPos)
        YPos += 50
        XPos = 10
        MyFont = New Font("Arial", 12)
