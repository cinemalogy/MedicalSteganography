...
Public Class approvedbid2
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Conn.Open()
        Dim Cmd0 As New SqlCommand("Select * from approvedbit where Id='" & pkvar & "'", Conn)
    ...
    Sub disRecords()
        ...
        Dim adp As New SqlDataAdapter("select Id ,SupplierId ,Suppliername ,Company ,Email ,NotificationId ,ItemId , ItemName ,BiddingPrice ,Warranty ,ManufacturingYear ,Time as 'Applied Time', Status From approvedbit Where Email = '" & supname & "' order by Id", Conn)
        adp.Fill(DS1)
        DataGridView1.DataSource = DS1.Tables(0)
        If Conn.State = ConnectionState.Open Then Conn.Close()
    End Sub

    Private Sub approvedbid2_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        disRecords()
    End Sub
