...
Public Class approvedbid1
    ...
    Sub disRecords()
        ...
        Dim adp As New SqlDataAdapter("select Id ,SupplierId ,Suppliername ,Company ,NotificationId ,ItemId , ItemName ,BiddingPrice ,Warranty ,ManufacturingYear ,Time as 'Applied Time', Status From approvedbit order by Id", Conn)
        adp.Fill(DS1)
        DataGridView1.DataSource = DS1.Tables(0)
        If Conn.State = ConnectionState.Open Then Conn.Close()
    End Sub

    Private Sub approvedbid1_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        disRecords()
    End Sub
End Class