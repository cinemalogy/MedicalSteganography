...
Public Class viewitemsordered
    ...
    Sub disRecords()
        ...
        Dim adp As New SqlDataAdapter("select NotificationId ,IdemId ,ItemName ,Description ,Quantity ,District ,BidStart ,BidEnd ,Time as 'Published Time'  From additem order by Time", Conn)
        adp.Fill(DS1)
        DataGridView1.DataSource = DS1.Tables(0)
        If Conn.State = ConnectionState.Open Then Conn.Close()
    End Sub

    Private Sub viewitemsordered_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        disRecords()
    End Sub
