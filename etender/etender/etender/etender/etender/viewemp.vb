...
Public Class viewemp
    ...
    Private Sub DataGridView1_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DataGridView1.CellContentClick
        ...
        Conn.Open()
        Dim Cmd0 As New SqlCommand("Select * from addemp where Id='" & pkvar & "'", Conn)
    ...
    Sub disRecords()
        ...
        Dim adp As New SqlDataAdapter("select Id ,EmployeeId ,EmployeeName ,EmployeeEmail ,Department ,Gender ,DOB ,MaritalStatus ,Address ,Phone ,BloodGroup  From addemp order by Id", Conn)
        adp.Fill(DS1)
