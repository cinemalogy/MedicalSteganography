...
Public Class EmployeeListReport
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        ...
        Dim adp As New SqlDataAdapter("Select empcode,empname,phoneno,designationname,salary From empdetTab  order by empcode", Conn)
        adp.Fill(DS1)
    ...
    Private Sub PrintDocument1_PrintPage(ByVal sender As System.Object, ByVal e As System.Drawing.Printing.PrintPageEventArgs) Handles PrintDocument1.PrintPage
        ...
        XPos = 10
        e.Graphics.DrawString("Cust Care Administration", MyFont, Brushes.Black, XPos, YPos)
        YPos += 50
        ...
        XPos = 10
        MyFont = New Font("Arial", 12)
        e.Graphics.DrawString("EmpCode", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
        e.Graphics.DrawString("EmpName", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
        e.Graphics.DrawString("PhoneNo", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
        e.Graphics.DrawString("DesignationName", MyFont, Brushes.Black, XPos, YPos)
        XPos = XPos + 150
